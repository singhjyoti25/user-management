...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">user-management-system documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-1ab0a6b675dc4cd246ae050db3d01578"' : 'data-target="#xs-components-links-module-AppModule-1ab0a6b675dc4cd246ae050db3d01578"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-1ab0a6b675dc4cd246ae050db3d01578"' :
                                            'id="xs-components-links-module-AppModule-1ab0a6b675dc4cd246ae050db3d01578"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/NewComponentComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >NewComponentComponent</a>
                                            </li>
                                            <li class="link">
